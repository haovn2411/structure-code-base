...
{
    public class ReorderVideoCommandHandler : ICommandHandler<Command.ReorderVideoCommand>
    {
        private readonly ICourseRepository _courseRepository;
        private readonly IUnitOfWork _unitOfWork;

        public ReorderVideoCommandHandler(ICourseRepository courseRepository, IUnitOfWork unitOfWork)
        {
            _courseRepository = courseRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Result> Handle(Command.ReorderVideoCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                course.ReorderVideo(request.VideoId, request.NewOrder);
