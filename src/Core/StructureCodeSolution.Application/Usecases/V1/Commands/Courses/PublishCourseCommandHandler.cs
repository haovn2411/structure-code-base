...
{
    public class PublishCourseCommandHandler : ICommandHandler<Command.PublishCourseCommand>
    {
        ...
        public async Task<Result> Handle(Command.PublishCourseCommand request, CancellationToken cancellationToken)
        {
            try
            {
